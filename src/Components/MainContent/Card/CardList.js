  ...
  return (
    <div className={styles["cardList"]}>
      <div style={{ display: "flex" }}>
        <div
          className={styles["cardList__background"]}
          style={{
        ...
        ></div>
        <div className={styles["cardList__gradient"]}></div>
      </div>
      <p className={styles["cardList__name"]}>{name}</p>
      <p className={styles["cardList__description"]}>{description}</p>
      ...
      {thumb === "up" ? (
        <button
          className={styles["icon-button-featured-List"]}
          aria-label="thumbs up"
        >
          <img
            src="img/thumbs-up.svg"
      ...
      <div className={styles["card__gauge_list"]}>
        <div
